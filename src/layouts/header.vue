...
import { urlGet, saveStorage, getStorage, domainGet } from '@/utils';
  ...
  <div class="v-header" :style="{ backgroundColor: `${headerColor} !important` }">
    <div class="header-content">
      ...
      <div v-else class="loginbtn">
        <nuxt-link :to="localePath(`/login?url=${encodeURIComponent(`www${domainGet()}`)}`)" class="login_font">
          Login
        </nuxt-link>
        <nuxt-link
          :to="localePath(`/login?url=${encodeURIComponent(`www${domainGet()}`)}`)"
