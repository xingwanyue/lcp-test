        ...
        <div class="content">
          <div class="one_card img_left">
            <div class="one_card_left">
              <img src="../../public/img/products/mock_picture1.png" />
            </div>
            <div class="one_card_right">
              <div class="one_card_right_forMid">
                ...
                <div class="right_click">
                  ...
                  <div class="arrow">
                    <img src="../../public/img/products/orange_arrow_right.svg" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="one_card img_right" data-aos="fade-up" data-aos-duration="1000">
            <div class="one_card_left">
              <img src="../../public/img/products/mock_picture2.png" />
            </div>
            <div class="one_card_right">
              <div class="one_card_right_forMid">
          ...
          <div class="one_card img_left" data-aos="fade-up" data-aos-duration="1000">
            <div class="one_card_left">
              <img src="../../public/img/products/mock_picture3.png" />
            </div>
            <div class="one_card_right">
              <div class="one_card_right_forMid">
          ...
          <div class="one_card img_right" data-aos="fade-up" data-aos-duration="1000">
            <div class="one_card_left">
              <img src="../../public/img/products/mock_picture4.png" />
            </div>
            <div class="one_card_right">
              <div class="one_card_right_forMid">
...
.bank_wrapper {
  padding: 0 30px;
  overflow: hidden;
  background: linear-gradient(#ffefe1 0%, #ffffff 657px, #ffffff 0px, #ffffff);
  .bank {
    max-width: 1200px;
    ...
    .content {
      .one_card {
        ...
        .one_card_right {
          grid-area: one_card_right;
          display: flex;
          justify-content: center;
          align-items: center;
          .one_card_right_forMid {
            .right_title {
              font-weight: 500;
              font-size: 32px;
              color: #201515;
